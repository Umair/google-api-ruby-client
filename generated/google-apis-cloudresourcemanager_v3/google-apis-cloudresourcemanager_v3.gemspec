require File.expand_path("lib/google/apis/cloudresourcemanager_v3/gem_version", __dir__)
gem_version = Google::Apis::CloudresourcemanagerV3::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudresourcemanager_v3"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Resource Manager API V3"
  gem.description =
      "This is the simple REST client for Cloud Resource Manager API V3." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudresourcemanager_v3/v#{gem_version}",
