require File.expand_path("lib/google/apis/pagespeedonline_v5/gem_version", __dir__)
gem_version = Google::Apis::PagespeedonlineV5::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-pagespeedonline_v5"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for PageSpeed Insights API V5"
  gem.description =
      "This is the simple REST client for PageSpeed Insights API V5." \
      ...
      " this client to access the PageSpeed Insights API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-pagespeedonline_v5/v#{gem_version}",
