require File.expand_path("lib/google/apis/vmmigration_v1alpha1/gem_version", __dir__)
gem_version = Google::Apis::VmmigrationV1alpha1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-vmmigration_v1alpha1"
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-vmmigration_v1alpha1/v#{gem_version}",
