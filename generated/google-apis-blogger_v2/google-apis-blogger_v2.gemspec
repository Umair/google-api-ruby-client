require File.expand_path("lib/google/apis/blogger_v2/gem_version", __dir__)
gem_version = Google::Apis::BloggerV2::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-blogger_v2"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Blogger API V2"
  gem.description =
      "This is the simple REST client for Blogger API V2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-blogger_v2/v#{gem_version}",
