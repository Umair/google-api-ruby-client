require File.expand_path("lib/google/apis/alertcenter_v1beta1/gem_version", __dir__)
gem_version = Google::Apis::AlertcenterV1beta1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-alertcenter_v1beta1"
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-alertcenter_v1beta1/v#{gem_version}",
