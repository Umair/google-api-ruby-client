require File.expand_path("lib/google/apis/recommendationengine_v1beta1/gem_version", __dir__)
gem_version = Google::Apis::RecommendationengineV1beta1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-recommendationengine_v1beta1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Recommendations AI (Beta) V1beta1"
  gem.description =
      "This is the simple REST client for Recommendations AI (Beta) V1beta1." \
      ...
      " this client to access the Recommendations AI (Beta), but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-recommendationengine_v1beta1/v#{gem_version}",
