require File.expand_path("lib/google/apis/analyticsadmin_v1alpha/gem_version", __dir__)
gem_version = Google::Apis::AnalyticsadminV1alpha::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-analyticsadmin_v1alpha"
  ...
  gem.description =
      ...
      " this client to access the Google Analytics Admin API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-analyticsadmin_v1alpha/v#{gem_version}",
