require File.expand_path("lib/google/apis/vectortile_v1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-vectortile_v1"
  gem.version = Google::Apis::VectortileV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Semantic Tile API V1"
  gem.description =
      "This is the simple REST client for Semantic Tile API V1." \
      ...
      " this client to access the Semantic Tile API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-vectortile_v1/v#{Google::Apis::VectortileV1::GEM_VERSION}",
