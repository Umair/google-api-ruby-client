require File.expand_path("lib/google/apis/displayvideo_v2/gem_version", __dir__)
gem_version = Google::Apis::DisplayvideoV2::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-displayvideo_v2"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Display & Video 360 API V2"
  gem.description =
      "This is the simple REST client for Display & Video 360 API V2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-displayvideo_v2/v#{gem_version}",
