require File.expand_path("lib/google/apis/servicedirectory_v1/gem_version", __dir__)
gem_version = Google::Apis::ServicedirectoryV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-servicedirectory_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Service Directory API V1"
  gem.description =
      "This is the simple REST client for Service Directory API V1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-servicedirectory_v1/v#{gem_version}",
