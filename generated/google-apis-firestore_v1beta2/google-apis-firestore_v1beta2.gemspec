...
gem_version = Google::Apis::FirestoreV1beta2::GEM_VERSION
...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Cloud Firestore API V1beta2"
  gem.description =
      "This is the simple REST client for Cloud Firestore API V1beta2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-firestore_v1beta2/v#{gem_version}",
