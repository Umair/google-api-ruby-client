require File.expand_path("lib/google/apis/chromepolicy_v1/gem_version", __dir__)
gem_version = Google::Apis::ChromepolicyV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-chromepolicy_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Chrome Policy API V1"
  gem.description =
      "This is the simple REST client for Chrome Policy API V1." \
      ...
      " this client to access the Chrome Policy API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-chromepolicy_v1/v#{gem_version}",
