require File.expand_path("lib/google/apis/remotebuildexecution_v1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-remotebuildexecution_v1"
  gem.version = Google::Apis::RemotebuildexecutionV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Remote Build Execution API V1"
  gem.description =
      "This is the simple REST client for Remote Build Execution API V1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-remotebuildexecution_v1/v#{Google::Apis::RemotebuildexecutionV1::GEM_VERSION}",
