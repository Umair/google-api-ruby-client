require File.expand_path("lib/google/apis/sqladmin_v1beta4/gem_version", __dir__)
gem_version = Google::Apis::SqladminV1beta4::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-sqladmin_v1beta4"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud SQL Admin API V1beta4"
  gem.description =
      "This is the simple REST client for Cloud SQL Admin API V1beta4." \
      ...
      " this client to access the Cloud SQL Admin API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-sqladmin_v1beta4/v#{gem_version}",
