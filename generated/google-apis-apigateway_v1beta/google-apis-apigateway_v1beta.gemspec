require File.expand_path("lib/google/apis/apigateway_v1beta/gem_version", __dir__)
gem_version = Google::Apis::ApigatewayV1beta::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-apigateway_v1beta"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for API Gateway API V1beta"
  gem.description =
      "This is the simple REST client for API Gateway API V1beta." \
      ...
      " this client to access the API Gateway API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-apigateway_v1beta/v#{gem_version}",
