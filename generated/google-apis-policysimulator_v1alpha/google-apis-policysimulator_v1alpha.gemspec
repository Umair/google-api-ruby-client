require File.expand_path("lib/google/apis/policysimulator_v1alpha/gem_version", __dir__)
gem_version = Google::Apis::PolicysimulatorV1alpha::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-policysimulator_v1alpha"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Policy Simulator API V1alpha"
  gem.description =
      "This is the simple REST client for Policy Simulator API V1alpha." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-policysimulator_v1alpha/v#{gem_version}",
