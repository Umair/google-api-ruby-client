require File.expand_path("lib/google/apis/doubleclickbidmanager_v1_1/gem_version", __dir__)
gem_version = Google::Apis::DoubleclickbidmanagerV1_1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-doubleclickbidmanager_v1_1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for DoubleClick Bid Manager API V1_1"
  gem.description =
      "This is the simple REST client for DoubleClick Bid Manager API V1_1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-doubleclickbidmanager_v1_1/v#{gem_version}",
