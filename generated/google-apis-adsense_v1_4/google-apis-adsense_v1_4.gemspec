require File.expand_path("lib/google/apis/adsense_v1_4/gem_version", __dir__)
gem_version = Google::Apis::AdsenseV1_4::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-adsense_v1_4"
  ...
  gem.description =
      ...
      " this client to access the AdSense Management API, but note that some" \
      " services may provide a separate modern client that is easier to use."
  gem.homepage = "https://github.com/google/google-api-ruby-client"
  gem.license = "Apache-2.0"
  gem.metadata = {
    "bug_tracker_uri" => "https://github.com/googleapis/google-api-ruby-client/issues",
    "changelog_uri" => "https://github.com/googleapis/google-api-ruby-client/tree/main/generated/google-apis-adsense_v1_4/CHANGELOG.md",
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-adsense_v1_4/v#{gem_version}",
    "source_code_uri" => "https://github.com/googleapis/google-api-ruby-client/tree/main/generated/google-apis-adsense_v1_4"
  }
