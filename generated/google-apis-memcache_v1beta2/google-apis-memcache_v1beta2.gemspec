require File.expand_path("lib/google/apis/memcache_v1beta2/gem_version", __dir__)
gem_version = Google::Apis::MemcacheV1beta2::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-memcache_v1beta2"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Memorystore for Memcached API V1beta2"
  gem.description =
      "This is the simple REST client for Cloud Memorystore for Memcached API V1beta2." \
      ...
      " this client to access the Cloud Memorystore for Memcached API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-memcache_v1beta2/v#{gem_version}",
