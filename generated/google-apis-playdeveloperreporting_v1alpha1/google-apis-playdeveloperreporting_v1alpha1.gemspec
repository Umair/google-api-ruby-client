require File.expand_path("lib/google/apis/playdeveloperreporting_v1alpha1/gem_version", __dir__)
gem_version = Google::Apis::PlaydeveloperreportingV1alpha1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-playdeveloperreporting_v1alpha1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Google Play Developer Reporting API V1alpha1"
  gem.description =
      "This is the simple REST client for Google Play Developer Reporting API V1alpha1." \
      ...
      " this client to access the Google Play Developer Reporting API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-playdeveloperreporting_v1alpha1/v#{gem_version}",
