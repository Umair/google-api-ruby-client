require File.expand_path("lib/google/apis/cloudcommerceprocurement_v1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudcommerceprocurement_v1"
  gem.version = Google::Apis::CloudcommerceprocurementV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Commerce Partner Procurement API V1"
  gem.description =
      "This is the simple REST client for Cloud Commerce Partner Procurement API V1." \
      ...
      " this client to access the Cloud Commerce Partner Procurement API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudcommerceprocurement_v1/v#{Google::Apis::CloudcommerceprocurementV1::GEM_VERSION}",
