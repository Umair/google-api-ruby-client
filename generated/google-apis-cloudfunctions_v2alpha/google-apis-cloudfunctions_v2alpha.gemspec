require File.expand_path("lib/google/apis/cloudfunctions_v2alpha/gem_version", __dir__)
gem_version = Google::Apis::CloudfunctionsV2alpha::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudfunctions_v2alpha"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Functions API V2alpha"
  gem.description =
      "This is the simple REST client for Cloud Functions API V2alpha." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudfunctions_v2alpha/v#{gem_version}",
