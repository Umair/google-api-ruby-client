require File.expand_path("lib/google/apis/domains_v1alpha2/gem_version", __dir__)
gem_version = Google::Apis::DomainsV1alpha2::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-domains_v1alpha2"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Domains API V1alpha2"
  gem.description =
      "This is the simple REST client for Cloud Domains API V1alpha2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-domains_v1alpha2/v#{gem_version}",
