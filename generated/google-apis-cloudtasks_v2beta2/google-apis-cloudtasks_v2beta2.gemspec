require File.expand_path("lib/google/apis/cloudtasks_v2beta2/gem_version", __dir__)
gem_version = Google::Apis::CloudtasksV2beta2::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudtasks_v2beta2"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Tasks API V2beta2"
  gem.description =
      "This is the simple REST client for Cloud Tasks API V2beta2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudtasks_v2beta2/v#{gem_version}",
