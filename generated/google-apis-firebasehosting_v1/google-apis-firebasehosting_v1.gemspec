require File.expand_path("lib/google/apis/firebasehosting_v1/gem_version", __dir__)
gem_version = Google::Apis::FirebasehostingV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-firebasehosting_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Firebase Hosting API V1"
  gem.description =
      "This is the simple REST client for Firebase Hosting API V1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-firebasehosting_v1/v#{gem_version}",
