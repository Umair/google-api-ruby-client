require File.expand_path("lib/google/apis/fcm_v1/gem_version", __dir__)
gem_version = Google::Apis::FcmV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-fcm_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Firebase Cloud Messaging API V1"
  gem.description =
      "This is the simple REST client for Firebase Cloud Messaging API V1." \
      ...
      " this client to access the Firebase Cloud Messaging API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-fcm_v1/v#{gem_version}",
