require File.expand_path("lib/google/apis/deploymentmanager_v2beta/gem_version", __dir__)
gem_version = Google::Apis::DeploymentmanagerV2beta::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-deploymentmanager_v2beta"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Deployment Manager V2 API V2beta"
  gem.description =
      "This is the simple REST client for Cloud Deployment Manager V2 API V2beta." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-deploymentmanager_v2beta/v#{gem_version}",
