require File.expand_path("lib/google/apis/playablelocations_v3/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-playablelocations_v3"
  gem.version = Google::Apis::PlayablelocationsV3::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Playable Locations API V3"
  gem.description =
      "This is the simple REST client for Playable Locations API V3." \
      ...
      " this client to access the Playable Locations API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-playablelocations_v3/v#{Google::Apis::PlayablelocationsV3::GEM_VERSION}",
