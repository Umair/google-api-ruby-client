require File.expand_path("lib/google/apis/calendar_v3/gem_version", __dir__)
gem_version = Google::Apis::CalendarV3::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-calendar_v3"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Calendar API V3"
  gem.description =
      "This is the simple REST client for Calendar API V3." \
      ...
      " this client to access the Calendar API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-calendar_v3/v#{gem_version}",
