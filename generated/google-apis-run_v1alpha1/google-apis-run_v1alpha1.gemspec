require File.expand_path("lib/google/apis/run_v1alpha1/gem_version", __dir__)
gem_version = Google::Apis::RunV1alpha1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-run_v1alpha1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Run Admin API V1alpha1"
  gem.description =
      "This is the simple REST client for Cloud Run Admin API V1alpha1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-run_v1alpha1/v#{gem_version}",
