require File.expand_path("lib/google/apis/compute_beta/gem_version", __dir__)
gem_version = Google::Apis::ComputeBeta::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-compute_beta"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Compute Engine API Beta"
  gem.description =
      "This is the simple REST client for Compute Engine API Beta." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-compute_beta/v#{gem_version}",
