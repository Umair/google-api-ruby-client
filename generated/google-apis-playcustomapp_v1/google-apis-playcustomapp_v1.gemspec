require File.expand_path("lib/google/apis/playcustomapp_v1/gem_version", __dir__)
gem_version = Google::Apis::PlaycustomappV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-playcustomapp_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Google Play Custom App Publishing API V1"
  gem.description =
      ...
      " this client to access the Google Play Custom App Publishing API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-playcustomapp_v1/v#{gem_version}",
