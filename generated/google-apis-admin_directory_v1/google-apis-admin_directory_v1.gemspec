require File.expand_path("lib/google/apis/admin_directory_v1/gem_version", __dir__)
gem_version = Google::Apis::AdminDirectoryV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-admin_directory_v1"
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-admin_directory_v1/v#{gem_version}",
