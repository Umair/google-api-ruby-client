require File.expand_path("lib/google/apis/analyticsdata_v1alpha/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-analyticsdata_v1alpha"
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-analyticsdata_v1alpha/v#{Google::Apis::AnalyticsdataV1alpha::GEM_VERSION}",
