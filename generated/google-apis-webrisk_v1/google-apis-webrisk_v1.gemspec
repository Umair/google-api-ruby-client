require File.expand_path("lib/google/apis/webrisk_v1/gem_version", __dir__)
gem_version = Google::Apis::WebriskV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-webrisk_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Web Risk API V1"
  gem.description =
      "This is the simple REST client for Web Risk API V1." \
      ...
      " this client to access the Web Risk API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-webrisk_v1/v#{gem_version}",
