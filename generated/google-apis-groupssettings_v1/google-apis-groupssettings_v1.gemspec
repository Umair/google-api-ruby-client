...
gem_version = Google::Apis::GroupssettingsV1::GEM_VERSION
...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Groups Settings API V1"
  gem.description =
      "This is the simple REST client for Groups Settings API V1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-groupssettings_v1/v#{gem_version}",
