require File.expand_path("lib/google/apis/safebrowsing_v4/gem_version", __dir__)
gem_version = Google::Apis::SafebrowsingV4::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-safebrowsing_v4"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Safe Browsing API V4"
  gem.description =
      "This is the simple REST client for Safe Browsing API V4." \
      ...
      " this client to access the Safe Browsing API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-safebrowsing_v4/v#{gem_version}",
