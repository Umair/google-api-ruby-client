require File.expand_path("lib/google/apis/cloudasset_v1p7beta1/gem_version", __dir__)
gem_version = Google::Apis::CloudassetV1p7beta1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudasset_v1p7beta1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Asset API V1p7beta1"
  gem.description =
      "This is the simple REST client for Cloud Asset API V1p7beta1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudasset_v1p7beta1/v#{gem_version}",
