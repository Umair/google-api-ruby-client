require File.expand_path("lib/google/apis/androiddeviceprovisioning_v1/gem_version", __dir__)
gem_version = Google::Apis::AndroiddeviceprovisioningV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-androiddeviceprovisioning_v1"
  ...
  gem.description =
      ...
      " this client to access the Android Device Provisioning Partner API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-androiddeviceprovisioning_v1/v#{gem_version}",
