require File.expand_path("lib/google/apis/androidmanagement_v1/gem_version", __dir__)
gem_version = Google::Apis::AndroidmanagementV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-androidmanagement_v1"
  ...
  gem.description =
      ...
      " this client to access the Android Management API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-androidmanagement_v1/v#{gem_version}",
