require File.expand_path("lib/google/apis/games_v1/gem_version", __dir__)
gem_version = Google::Apis::GamesV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-games_v1"
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-games_v1/v#{gem_version}",
