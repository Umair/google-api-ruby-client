require File.expand_path("lib/google/apis/firebasedynamiclinks_v1/gem_version", __dir__)
gem_version = Google::Apis::FirebasedynamiclinksV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-firebasedynamiclinks_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Firebase Dynamic Links API V1"
  gem.description =
      "This is the simple REST client for Firebase Dynamic Links API V1." \
      ...
      " this client to access the Firebase Dynamic Links API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-firebasedynamiclinks_v1/v#{gem_version}",
