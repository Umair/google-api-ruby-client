require File.expand_path("lib/google/apis/genomics_v1alpha2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-genomics_v1alpha2"
  gem.version = Google::Apis::GenomicsV1alpha2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Genomics API V1alpha2"
  gem.description =
      "This is the simple REST client for Genomics API V1alpha2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-genomics_v1alpha2/v#{Google::Apis::GenomicsV1alpha2::GEM_VERSION}",
