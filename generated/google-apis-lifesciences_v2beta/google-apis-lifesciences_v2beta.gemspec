require File.expand_path("lib/google/apis/lifesciences_v2beta/gem_version", __dir__)
gem_version = Google::Apis::LifesciencesV2beta::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-lifesciences_v2beta"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Life Sciences API V2beta"
  gem.description =
      "This is the simple REST client for Cloud Life Sciences API V2beta." \
      ...
      " this client to access the Cloud Life Sciences API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-lifesciences_v2beta/v#{gem_version}",
