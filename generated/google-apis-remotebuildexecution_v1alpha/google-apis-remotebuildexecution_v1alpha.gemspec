require File.expand_path("lib/google/apis/remotebuildexecution_v1alpha/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-remotebuildexecution_v1alpha"
  gem.version = Google::Apis::RemotebuildexecutionV1alpha::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Remote Build Execution API V1alpha"
  gem.description =
      "This is the simple REST client for Remote Build Execution API V1alpha." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-remotebuildexecution_v1alpha/v#{Google::Apis::RemotebuildexecutionV1alpha::GEM_VERSION}",
