require File.expand_path("lib/google/apis/dataflow_v1b3/gem_version", __dir__)
gem_version = Google::Apis::DataflowV1b3::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-dataflow_v1b3"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Dataflow API V1b3"
  gem.description =
      "This is the simple REST client for Dataflow API V1b3." \
      ...
      " this client to access the Dataflow API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dataflow_v1b3/v#{gem_version}",
