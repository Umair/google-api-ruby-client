require File.expand_path("lib/google/apis/iamcredentials_v1/gem_version", __dir__)
gem_version = Google::Apis::IamcredentialsV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-iamcredentials_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for IAM Service Account Credentials API V1"
  gem.description =
      ...
      " this client to access the IAM Service Account Credentials API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-iamcredentials_v1/v#{gem_version}",
