require File.expand_path("lib/google/apis/dataproc_v1beta2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-dataproc_v1beta2"
  gem.version = Google::Apis::DataprocV1beta2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Dataproc API V1beta2"
  gem.description =
      "This is the simple REST client for Cloud Dataproc API V1beta2." \
      ...
      " this client to access the Cloud Dataproc API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dataproc_v1beta2/v#{Google::Apis::DataprocV1beta2::GEM_VERSION}",
